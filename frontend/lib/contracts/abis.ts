...
export const LeaderboardV11ABI = [
  ...
  {
    inputs: [],
    name: 'percentToPlatformFeeReceiver',
    outputs: [{ name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_newPercent', type: 'uint256' }],
    name: 'setPercentToPlatformFeeReceiver',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  // Factory pagination (for LeaderboardFactory, included here for convenience)
  {
    inputs: [
...
export const StreamingLeaderboardABI = [
  ...
  { inputs: [], name: 'percentToBeneficiary', outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
  { inputs: [], name: 'percentToPlatformFeeReceiver', outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
