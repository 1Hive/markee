...
export function Footer() {
  return (
    <footer className="bg-[#060A2A] border-t border-[#8A8FBF]/20 py-14 flex flex-col items-center gap-[22px] text-[13px]">
      <Link href="/" aria-label="Markee home">
        <img src="/markee-logo.png" alt="Markee" className="w-10 h-10 rounded-[9px] block" />
      </Link>
      ...
      <div className="flex gap-[10px]">
        ...
        <SocialIcon href="https://discord.gg/UhhRDzwwkM" label="Discord">
      ...
      <div className="text-[#8A8FBF] font-mono text-[11px] tracking-[1px]">markee.xyz · © 2026</div>
    </footer>
  )
}
