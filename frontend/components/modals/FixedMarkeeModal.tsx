            ...
            <>
              ...
              <div className="mb-6 bg-gray-50 rounded-lg p-4 border border-gray-200">
                <p className="text-sm text-gray-700">
                  💡 <strong>How it works:</strong> Pay the fixed price to change this message. 
                  Anyone can change it by paying the same amount. All payments fund the Markee collective 
                  and you receive $ABC tokens in return.
                </p>
              </div>
