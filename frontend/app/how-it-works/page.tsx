  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center gap-8">
            ...
            <nav className="flex gap-6">
              <Link href="/how-it-works" className="text-markee font-medium">How it Works</Link>
      ...
      <section className="bg-white py-16 border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex gap-4">
            ...
            <Link 
              href="/ecosystem"
              className="inline-block bg-green-50 text-green-600 border-2 border-green-600 px-6 py-3 rounded-lg font-semibold hover:bg-white transition-colors"
            >
              View Ecosystem
            </Link>
          </div>
      ...
      <section className="py-16 bg-gray-50 border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Pricing Strategies</h2>
          
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-markee">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Leaderboard Strategy</h3>
              ...
              <p className="text-sm text-gray-600">
                <strong>Use case:</strong> Organizations and early believers investing in the cooperative's future
              </p>
            </div>

            <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-600">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Fixed Price Strategy</h3>
              <p className="text-gray-700 mb-3">
                Set price per message change. Pay once to update the message - simple and predictable pricing.
              </p>
              <p className="text-sm text-gray-600">
                <strong>Use case:</strong> Platform integrations where communities set their own pricing
              </p>
            </div>

            <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-600 opacity-60">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Platform Integration Strategy <span className="text-sm font-normal text-gray-500">(Coming Q2 2026)</span></h3>
              <p className="text-gray-700 mb-3">
                Seamlessly integrated into existing platforms with custom revenue sharing and community funding options.
              </p>
              <p className="text-sm text-gray-600">
                <strong>Use case:</strong> DAOs, communities, and platforms monetizing their digital spaces
              </p>
            </div>
          </div>

          <div className="mt-8 bg-markee-50 rounded-lg p-6">
            <p className="text-gray-700">
              <strong>Learn more:</strong> Check out our <Link href="https://revnet.eth.sucks/" target="_blank" className="text-markee hover:underline font-semibold">RevNet documentation</Link> to understand how revenue flows through the ecosystem, or explore our <Link href="/ecosystem" className="text-markee hover:underline font-semibold">Ecosystem page</Link> to see platform integrations.
            </p>
          </div>
        </div>
      </section>
